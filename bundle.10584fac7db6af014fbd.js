...
// Refactored imports to use code-splitting for navigating app

var componentRoutes = {
  // jsx structure into plain js object
  ...
  childRoutes: [{
    ...
    getComponent: function getComponent(location, cb) {
      // we invoke this function for code splitting optimizations
      // fetch component
      // we use system.import to modify bundle generated
      // to split off second bundle
      // cb takes error as first object
